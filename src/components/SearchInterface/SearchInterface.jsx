/**
 * SearchInterface Component — adapted for Smusic
 *
 * Import-path changes from the searchFeature/ original:
 *   '../hooks/hooks.js'   → local hooks within this folder (hooks.js)
 *   '../utils/utils.js'   → local utils.js
 *   '../types/types.js'   → local types.js
 *   './SearchInterface.module.css' → unchanged (same folder)
 */
 ...
 *
 * @param {{ apiClient: import('./apiClient.js').ApiClient, onTrackSelect?: Function }} props
 */
